...
FOR %%x IN ("\wme2a\testProj\xampplite\php\PEAR") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=\wme2a\testProj\xampplite\php\PEAR"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=\wme2a\testProj\xampplite\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=\wme2a\testProj\xampplite\php\php.exe"
GOTO :INSTALLED
